...
def train_network(model:MyANN_opt, train_set:tuple, val_set:tuple, opt:My_Opt, n_epoch, save_path, loss_func):
...
# ann2 = NeuralNetwork(n_inputs=256,n_hidden=8,n_outputs=10,dropout_rate=0.1)
ann_opt = MyANN_opt(n_inputs=256,n_hidden=16,n_outputs=10,dropout_rate=0.1,hidden_size=[16])

loss_func=cross_entropy_loss
my_opt = My_Opt(alpha=0.2, beta1=0.9, beta2=0.999, epsilon=1e-8,steps=[], gamma=0.2)
